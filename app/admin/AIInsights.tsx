  ...
  return (
    <div className="space-y-4 mb-8">
      ...
      <div className="flex items-center gap-3">
        <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 text-blue-600 text-xs font-semibold uppercase tracking-widest px-3.5 py-1.5 rounded-full">
          <Lightbulb className="w-3 h-3" />
          AI Insights
        </div>
        <span className="text-slate-500 text-xs">Generated by GPT-4o mini · Based on {submissions.length} submission{submissions.length !== 1 ? 's' : ''}</span>
      </div>
